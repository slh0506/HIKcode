	...
	: QWidget(parent)
{
	...
	ui.addWidget->resize(831, 541);
	ui.ModifyWidget->resize(831, 541);
...
{
	ui.addWidget->show();
	ui.ModifyIPLineEdit->clear();
	ui.ModifyPortLineEdit->clear();
	ui.ModifyUsernameLineEdit->clear();
	ui.ModifyPasswordLineEdit->clear();
}
