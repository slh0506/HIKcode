...
public:
    ...
    void setupUi(QWidget *CHikVisionMonitorClass)
    {
        ...
        ReviewLabel->setFrameShape(QFrame::NoFrame);
        ...
        ReviewLabel_2->setFrameShape(QFrame::NoFrame);
        ...
        ReviewLabel_3->setFrameShape(QFrame::NoFrame);
        ...
        ReviewLabel_4->setFrameShape(QFrame::NoFrame);
