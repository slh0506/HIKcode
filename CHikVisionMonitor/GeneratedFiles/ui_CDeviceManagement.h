...
public:
    ...
    void setupUi(QWidget *CDeviceManagement)
    {
        ...
        CDeviceManagement->resize(873, 583);
        ...
        gridLayout_8 = new QGridLayout(addWidget);
        ...
        gridLayout_8->addWidget(ExitButton, 0, 1, 1, 1);
        ...
        gridLayout_8->addWidget(splitter_2, 2, 0, 1, 1);


        gridLayout_5->addWidget(addWidget, 0, 1, 1, 1);
        ...
        gridLayout_7->addWidget(AddButton, 0, 1, 1, 1);
        ...
        gridLayout_7->addWidget(DeleteButton, 0, 3, 1, 1);
...
"};"));
        ...
        gridLayout_6->addWidget(ModifyExitButton, 0, 1, 1, 1);
        ...
        gridLayout_6->addWidget(splitter_4, 2, 0, 1, 1);
        ...
        ModifyIPLineEdit->setMinimumSize(QSize(0, 40));
        ...
        ModifyPortLineEdit->setMinimumSize(QSize(0, 40));
        ...
        ModifyUsernameLineEdit->setMinimumSize(QSize(0, 40));
        ...
        ModifyPasswordLineEdit->setMinimumSize(QSize(0, 40));

        gridLayout_3->addWidget(ModifyPasswordLineEdit, 3, 1, 1, 1);

        gridLayout_3->setRowMinimumHeight(0, 50);
        gridLayout_3->setRowMinimumHeight(1, 50);
        gridLayout_3->setRowMinimumHeight(2, 50);
        gridLayout_3->setRowMinimumHeight(3, 50);
        splitter_3->addWidget(layoutWidget_2);

        gridLayout_6->addWidget(splitter_3, 1, 0, 1, 1);


        gridLayout_5->addWidget(ModifyWidget, 1, 1, 1, 1);
