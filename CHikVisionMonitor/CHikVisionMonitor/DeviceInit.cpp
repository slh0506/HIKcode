...
long CDeviceInit::loginSDKInit(CMonitorDatabase::struSqliteData struSqlInfo)
{
...
long CDeviceInit::findFile(const long &lUserID, QDateTime beginDatetime, QDateTime endDatetime, const long &lFileChannel)
{
